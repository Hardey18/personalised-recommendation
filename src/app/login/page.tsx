        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-400 text-sm">Sign in to your KoreRec account to continue.</p>
            </div>
            ...
            <p className="text-center text-xs text-slate-400 mt-6">
              ...
              <span className="text-brand-500 font-medium cursor-pointer hover:text-brand-600 transition-colors">
